...
$WTuser->include_js_script("wetterturnier.soundings-cosmo");

// Location of the xml file containing the 'available soundings'
$xml_file = sprintf("%s/user/xmlfiles/soundings-cosmo.xml",
...
jQuery(document).on('ready',function() {
   ...
   $("#wt-sounding-container").wtsoundingscosmo("<?php print $xml_file; ?>",setImageWidth);
