...
class WP_wetterturnier_widget_webcams extends WP_Widget
{
    ...
    function __construct() {
        ...
        $control_ops = array('width'=>300, 'height'=>350, 'id_base'=>'wp_wetterturnier_webcams' );
        $this->WP_Widget('wtwidget_tournaments', __('Wetterturnier Webcams'),"widget",
