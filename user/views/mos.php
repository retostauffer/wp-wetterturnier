...
foreach ( $showdays as $showday ) {
         ...
         <div class="wt-twocolumn wrapper">
            <div class="wt-twocolumn column-left" style="width: 65%;">
               ...
               <form method="post" action="<?php print $WTuser->curPageURL(); ?>">
                  <input class="button" type="submit" name="21z" value="<?php _e("DO 21 UTC","wpwt"); ?>" />
                  <input class="button" type="submit" name="3z" value="<?php _e("FR 3 UTC","wpwt"); ?>" />
                  <input class="button" type="submit" name="9z" value="<?php _e("FR 9 UTC","wpwt"); ?>" />
               </form>
            </div>
      ...
      $WTuser->archive_show( 'mos', $current->tdate, false, $showday );
