...
class WP_wetterturnier_widget_windy extends WP_Widget
{
    ...
    function __construct() {
        ...
        $control_ops = array('width'=>300, 'height'=>300, 'id_base'=>'wp_wetterturnier_windy' );
    ...
    */
    ...
    function widget( $args, $instance ) {
        ...
        if (! $this->isMobileDevice() and get_user_option("wt_windy") == "on" ) {
    ...
    function show_windy() {
        ...
        echo "<iframe width=300 height=300 src='https://embed.windy.com/embed2.html?lat=$lat&lon=$lon&zoom=5&level=surface&overlay=radar&menu=&message=true&marker=&calendar=&pressure=true&type=map&location=coordinates&detail=&detailLat=$lat&detailLon=$lon&metricWind=kt&metricTemp=%C2%B0C&radarRange=-1' frameborder=0></iframe>";
        /*
        $args =
                                array('width'=>"300",
                                      'heigth'=>"300",
